...
export const faqs = [
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Does Big Boy Toyz offer cars for lease?",
        answer: `<p>We at Big Boy Toyz deal only in selling & purchasing of premium and exotic luxury cars. We do not offer our cars for rental or leasing purpose.</p>`,
      },
      {
      ...
      {
        question: "Does Big Boy Toyz offer cars for lease?",
        answer: `<p>We are known to be the best in business because of our fast and safe delivery process. We have a team dedicatedly working on new ways to deliver your car safely and in an efficient manner. We use closed body container and specialized trucks for exotic cars to be transported.</p>`,
      },
      {
        question: "How do you deliver the cars pan India?",
        answer: `<p>We have a fleet of closed body containers which are ready and on the go along with trained pilots specialized for these heavy duty closed body containers and specialized trucks. We have a strong logistics department which makes sure the deadlines are met.</p>`,
      },
      {
        question:
        ...
        answer: `<p>We love working closely with our clients and treat them as a part of our family. We are overjoyed whenever there is a customer who wants to do something special for his loved ones and we are glad to be a part of this process. Our marketing team works closely with the clients to bring their ideas and dream delivery to reality. We capture these special moments and publishe them on our Instagram handle for you to relive the experience.</p>`,
      },
      {
        question:
          "Do the demo/brand new car offered under BBT have company warranty on them?",
        answer: `<p>Yes, any brand new car or demo car being offered will have a company warranty with them. But in some cases, if they don't we at BBT have our own warranty of 6 months on engine and transmission. If there are any issues in the components related to engine and transmission we don't fix the part we replace it completely for a stress free ownership. We are proud of being the first one's and the only ones who offer a dedicated guarantee for the product we offer. You can further extend the warranty for 6 months or an year more.</p>`,
      },
      {
        question: "Can a particular car be arranged for me? (Pre-booking) ?",
        answer: `<p>We specialize in sourcing you your dream car. If there is any specific model in your mind or a particular color or registration state you would like, we can arrange them all. We take a timeline of 30 days in which our procurement team works on finding the exact products as per your specification and share the same with you. If you are satisfied with the options offered we move forward with the other financials but if not, your booking advance is 100% refundable.</p>`,
      },
      {
        question: "Why is the Buy-back policy only for one year?",
        answer: `<p>Buy back policy is a medium through which we give our clients the assurity that no matter how the product does on the market, if the market price falls or if the model gets discontinued by the manufacturer we are there to support you by giving you an assurance of taking the car back. With a fast emerging market we see today, where there are facelifts every year, having a one year buyback policy helps us protect the customer's interest plus we safeguard our investments in that particular product as well. Predicting the market 2 years down the line is not idealistic as we believe reason being - the fluctuating automobile market and the prices depending on the change in government norms and regulations.</p>`,
      },
      {
        question:
        ...
        answer: `<p>We are an organization based on values and ethics, we do not discriminate between our customers be it a repeat client or someone new. Our guidelines and principles are transparent therefore we have a strong customer base of almost 40,000+ customers who have faith in our policies. We are thankful to each and every customer who has helped us achieve the same.</p>`,
      },
      {
        question: "Can we test drive the cars, before finalizing it?",
        answer: `<p>One of the reasons we are able to maintain our machines in pristine condition is because of our policy of not offering test drives without an advance payment. We do not have any demo cars to offer a test drive. How would you feel if you get to know that the car you are considering has been driven by multiple people and for this many kms? It definitely ruins the complete experience with certain doubts arising. Not to worry, we offer you a way out where we help you take the test drive by transferring 10% of the deal value by which you have the chance to completely have a convincing test drive with our sales representative. They will give you a thorough walkaround of the features and different driving modes to help you choose better.</p>`,
      },
      {
        question:
          "Does the cars have history of any accidental records or meter tampering?",
        answer: `<p>We offer you a guarantee that all our cars are legally and physically genuine. We do not deal in cars which have a bad history or any legal issues. We offer you to even have the car checked with their respective brands for your complete satisfaction after the car is advanced.</p>`,
      },
      {
        question: "How Much Time Does It Take To Get The Car Transferred?",
        answer: `<p>Working in a diverse country like India where all the RTO's have a different set of documents and process, we take 60 days from the date of purchase to transfer the car in that particular state in your name.</p>`,
      },
      {
        question:
          "Is It Possible To Drive Another State Registered Car In My City?",
        answer: `<p>Every state has its own rules regarding other state registered cars. Though with the One country one border rule expected around the bend, most states allow various other state registered cars to ply. This resistance to other state cars plying has reduced considerably. Also very soon, a new rule is expected whereby a buyer can just pay a difference in road tax percentage wise and re-register if need. So its advisable to drive an out state registered car with the existing registration and re-register in their own state once this rule comes into effect. Of course, keeping in mind the fact that the easiest and most economical way to drive a car is by retaining the existing registration of the car. It can later be transferred legally in the buyers name in the same state. It is registered by means of a LIC policy and registered rental deed which various RTO agents of the state facilitate in a legal bound framework accepted by the RTO.</p>`,
      },
      {
        question:
          "Does BBT Own The Cars I See Online Or Are They Owned By The Other Individuals / Dealers?",
      ...
      {
        question:
          "What About The Aftersales Services Once We Buy Any Car From BBT?",
        answer: `<p>We have a huge workshop and team of best experts in Gurgaon Service Centre, where we service and maintain all our cars. In a scenario, where you are situated in a different city, our team will fly down to you to service your car. If the car needs to be transported to our service center, we can arrange for the same.</p>`,
      },
      {
        question:
          'What Does It Mean By "All BBT Cars Are BBT Quality Certified"?',
        answer: `<p>Every car sold by BBT is certified - which means no flood or legal case and no salvage history. It also means that the car has passed the 151 check point inspection and undergone a detailed reconditioning process. At Big Boy Toyz, there is a certainty that everything is being offered to perfection in terms of quality, service and the inventory.</p>`,
      },
      {
        question: 'Are Cars Ever Sold "As-It-Is"?',
        answer: `<p>None of the cars bought by BBT are ever sold to you "as-it-is." In addition to replacing worn parts found during our 151 point inspection, we spend an average of 15 hours reconditioning each car at the BBT-Workshop. When it comes to the exterior, we pull out dimples, buff and color-match scratches, restore headlights, and repair discoloration caused by acid or oxidation, if required we do replace the tyres with brand new tyres as per the original size and company code from the dealership. For the interior of the car, we remove stains, repair holes or tears, remove debris from all surfaces and hard to reach places, and repair or replace any excessively worn carpet. We make sure every car getting delivered is completely checked for interior and exterior details. You only have to worry about refueling the tank and enjoying the ride, rest is all taken care by us.</p>`,
      },
      {
        question:
          "What Tools Do You Provide To Help Me Find A Suitable Car In My Budget?",
        answer: `<p>We have an active website by the name www.bigboytoyz.com where in you can search for a suitable ride as per your requirements. You can use the filter to search our website on basis of type (sedan, sports car or SUV) and budget(starting from 40 lakhs and above). We also have a 24*7 active social media platforms for your enquiries as well as WhatsApp, Email & active board line numbers which are - (+91) 9999-9999-83, (+91) 124 44 666 666. Enquiries related to "Sell You Car" can be contacted on (+91) 9999-9999-15. We are just a call away to answer all your queries and support. </p>`,
      },
      {
        question:
          "How Can I Be Notified Regarding The Cars I Like Once They Are Added To Your Inventory?",
        answer: `To have a constant update regarding our inventories our website is always updated with latest add ones to the stock we have available at our showrooms across Pan India. We just need a first contact touch base with you as per your requirements which you can address by either calling us over our active board line number. You can also drop an email stating your requirements and our Sales Team will have an active response to your query within a time frame of 10 minutes. We will then be in constant touch with you to assist you with best wheels ASAP.`,
      },
      {
        question:
          "If I Find A Car Online Can I See It In Person Before I Make A Decision?",
        answer: `<p>You are always welcome to any of our showroom located Pan India. We are open all days from 10am to 10pm. In case you are interested in a test drive, we need an advance as a security deposit which can be done in the following ways - You can pay 2,00,000 Rs right away and reserve your car online via BIG BOY TOYZ website : www.bigboytoyz.com for the next 24hours. Later you can pay the rest of the amount by following options -<br /> Option-1 - Pay 10% of the car amount within 24 hours when reserving the car and pay the remaining 90% in next 7 days. <br />  OR <br />  Option-2. You can directly pay the 10% amount of the car as the booking amount can pay rest of the payment in next 7 days. You can take the test drive of the car after paying 10% of the booking amount and can also get it checked at the nearest authorized dealership and then if you don't like the car then in that case, your booking amount will get refunded within 30 days from date of cancellation, this is only as we don't have dummy or test drive vehicles as we need to maintain the low kms on the car so that you can enjoy the maximum shelf life for the car.</p>`,
      },
      {
        question:
          "Do I Need To Make An Appointment To Check Out Cars At The BBT Outlets?",
        answer: `<p>You never need an appointment to check out cars at Big Boy Toyz. Feel free to visit our showroom and have a cup of coffee with us. Enjoy the luxury fleet and feel at home.</p>`,
      },
      {
        question:
          "What's The Procedure To Transfer Outstation Registered Cars Under My Name?",
        answer: `<p>We create a proper rental agreement in your name to transfer the car on other state registered vehicle by attaching your permanent address proof in that specific rto which states legal and you can drive any outstation registered vehicle in your state without any problem and no additional road tax needs to be paid. The complete RTO Transfer process will be done within 90 days from date of complete payment received and Transferred RC will be sent via fast track courier to your permanent address.</p>`,
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer: `<p>Customer's booking amount is 100% refundable in case the deal doesn't happen for any reason. We don't keep advances as this helps our customer's trust us more and be open for future transaction without any hesitation.</p>`,
      },
      {
        question: "Does BBT Offer Any Buy Back And Warranty Assurance?",
        answer: `<p>Yes we do offer buy back assurance on vehicles sold by BBT which are above 2010 model and driven less than 30,000kms. Buy Back Policy for Sedan/SUV: Drive the car for 15,000 km or 1 year. We will take the car back from you at 25% depreciation Buy Back Policy Sports/Coupe/Convertible: Drive the car for 5,000 km or 1 year. We will take the car back from you at 25% depreciation</p>`,
      },
      {
        question: "What's The Booking And Balance Payment Procedure?",
        answer: `<p>To book your vehicle we need a 10% of the booking amount which can be done via RTGS. After the booking amount is paid you have 7 days to complete the remaining payment. Once the booking amount is paid, you can take a test drive of the car. In case you are not satisfied with your choice the booking amount is 100% refundable within 30 days from the date of cancellation. The car will be ready for delivery once the total amount is payed.</p>`,
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer: `<p>Capturing pictures and videos from your personal cellphone or an Ipad is permitted. Professional shooting equipment's, professional cameras and video vlogging are not permitted. However, we at BBT have our dedicated media day on every Saturday in which you can first seek permission through email by our marketing team and then come and display your photography skills.</p>`,
      },
      {
        question:
          "How Different Is The Experience Of Buying Pre-Used Cars From BBT Compared To Company Certified Pre Used Cars Dealerships?",
        answer: `<p>We at BBT do our best in being as versatile as we can, this shows by our ground breaking policies (explained under a different FAQ) and the array of options on offer. In a company owned pre used dealership you are restricted to one brand, having to compare the cars side by side with other brands and models is a task as it is time consuming for you to move around showrooms trying to find the best suitable option. We are a one stop shop where you can compare cars from all the luxury car brands which are on offer under one roof. For Example :- Mercedes Benz S class vs BMW 730ld vs Audi A8 vs Maserati Quattro Porte, you can physically sit and feel each car individually to have a clear and a better understanding as to which one is tailor made for your comfort and style, where else do you have this ease of buying?</p>`,
      },
      {
        question: "Do All The Three Stores Have Service Facilities Available?",
        answer: `<p>We have our state-of-the-art workshop located in Gurgaon. Regarding our branches in Mumbai and Hyderabad we have special partners who help us cater our customer service and after sales respectively.</p>`,
      },
      {
        question: "Do We Modify Cars?",
        answer: `<p>We do not have a dedicated body shop where we manufacture body kits and accessories but we do offer services where we can help source an after-market body kit or alloys which can be installed by our after sales team. We offer leather upgrade in terms of seats and interior where you can choose the interior color of your choice and we can help tailor-made for you.</p>`,
      },
      {
        question:
        ...
        answer: `<p>We at BBT have a dedicated workshop and after sales team who are ready to source you any part from anywhere in the world. We have a strong network with all the company owned workshops and factories all across the world. Once you buy a car from us, there is no need to venture out trying to find a particular part or item, we are there for you!</p>`,
      },
      {
        question:
          "Why Don't You Deal In Regular Segments Like Fortuners, C Classes, 3 Series Etc.?",
        answer: `<p>We are focusing on the niche market as of now. It's very tough to find low mileage and top notch quality standard cars in this segment. Hence, we generally avoid this segment. However, fewer times excellent quality standards cross our eye and we make sure to invest in them. For instance, cars like 2018- 19 C class /Mercedes E- Class / 5 series.</p>`,
      },
      {
        question:
