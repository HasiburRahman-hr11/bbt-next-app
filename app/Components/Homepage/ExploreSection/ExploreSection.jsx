  ...
  return (
    <section className="bg-black">
      <div className="relative">
        <div className="text-box text-white absolute z-10 px-10 w-full right-0 top-0 pt-20 text-center md:w-5/12 md:text-left md:pt-32 lg:pt-52 lg:right-10 lg:max-w-3xl xl:max-w-4xl xl:right-0 2xl:pt-56 2xl:right-16 3xl:max-w-6xl 3xl:pt-72">
          <p className="uppercase text-lg mb-4 md:mb-8 lg:text-xl xl:mb-10 xl:text-2xl 2xl:mb-12 3xl:text-3xl 3xl:mb-14">LET'S KEEP IT SIMPLE.</p>
