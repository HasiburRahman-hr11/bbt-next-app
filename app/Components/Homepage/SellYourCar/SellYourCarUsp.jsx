...
const SellYourCarUsp = ({usp}) => {
  return (
    <li className='bg-dark-600 pl-8 pr-2 py-12 rounded-xl w-5.5/12 mt-8 lg:w-2.7/12 lg:rounded-2xl lg:pl-10 lg:py-16 3xl:pl-14 3xl:py-20 3xl:rounded-3xl'>
        ...
        <p className='text-white font-extralight text-2xl mt-4 [&>strong]:font-medium [&>strong]:block leading-normal xl:text-3xl xl:leading-relaxed 3xl:text-4xl 3xl:leading-relaxed'>{usp.title} <strong>{usp.titleStrong}</strong></p>
    </li>
  )
}
