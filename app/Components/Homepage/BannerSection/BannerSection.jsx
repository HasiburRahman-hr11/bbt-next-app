                    ...
                    >
                      <span className="absolute left-8 top-[50%] translate-y-[-50%]">
                        <Image
                          ...
                          height="17"
                          alt="Search Icon"
                          className="w-5 object-contain 2xl:w-8"
                        />
                      </span>
                      <input
                        type="search"
                        ...
                        className="w-full border-0 outline-none bg-transparent text-lg text-white 2xl:text-[1.5rem] pt-[1.5rem] pr-[4rem] pb-[1.2rem] pl-[5rem] 3xl:text-[2rem] "
                      />
                      <div
                      ...
                      >
                        <Image
                          ...
                          height="22"
                          alt="Filter Button"
                          className="w-6 1xl:w-[1.5rem] 2xl:w-7 hover:scale-110 transition-all duration-500 group-hover:invert 3xl:w-[3rem]"
                        />
                      </div>
                    </div>
                    <div>
