        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="container w-full h-full">
            <div className="flex h-full items-center py-[6rem]">
              <div className="w-full 3xl:max-w-[622px] max-w-[350px] lg:max-w-[400px]">
                <div className=" text-white ">
                  <img
                    src="/images/why-us/team-quote-icon.webp"
                    alt="Quote Icon"
                    className="object-contain h-auto inline-block w-[3rem] lg:w-[3.5rem] 3xl:w-[4.3rem]"
                  />
                  <p className="text-[2.5rem] lg:text-[3rem] 3xl:text-[4.5rem] underline my-[3rem] font-normal underline-offset-[5px] decoration-1">
                  ...
                  <img
                    ...
                    alt="Jatin Ahuja"
                    className="object-contain h-auto inline-block w-[14rem] lg:w-[16rem] 3xl:w-[19rem]"
                  />
                </div>
