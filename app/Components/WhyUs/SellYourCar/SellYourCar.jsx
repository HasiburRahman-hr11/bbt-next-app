      ...
      <div className="max-1920">
        <div className="container">
          ...
          <div className="flex flex-wrap justify-between mt-[4rem] md:max-w-[640px] md:mx-auto lg:max-w-none">
            <div className="w-full lg:w-[65%]">
              <ul>
                {usps.map((usp, index) => (
                  <li
                    key={index}
                    className="flex flex-wrap items-center py-[3rem] border-t border-t-[#B2B2B2] pr-[1rem] sm:items-start"
                  >
                    <div className="w-[3.5rem] 3xl:w-[6.4rem]">
                      <img
                        src={usp.icon}
                        alt="Icon"
                    ...
                    <div className="flex-[1] flex flex-wrap flex-col pl-[2rem] sm:flex-row sm:justify-between sm:pl-[4rem]">
                      <h5 className="text-[1.7rem] 3xl:text-[3rem] font-medium capitalize sm:w-[40%] lg:tracking-tight">
                        {usp.title}
                      </h5>
                      <p className="text-[1.2rem] 3xl:text-[2rem] font-normal mt-[1rem] sm:w-[53%] sm:mt-0">
                        {usp.description}
                      </p>
                    </div>
                  </li>
            ...
            <div className="w-full mt-[5rem] lg:w-[30%] lg:mt-0">
              <div className="bg-[#F4F4F1] py-[4rem] px-[3rem] rounded-[2rem] w-full mx-auto max-w-[400px]">
                <h3 className="text-[2rem] 3xl:text-[3.5rem] font-light [&>b]:font-medium">
                  Planning To Sell ? <br /> <b>Sell Your Car In 29 Minutes</b>
                </h3>

                <p className="text-[1.2rem] 3xl:text-[1.8rem] mt-[3rem] mb-[3rem]">
                ...
                >
                  <div className="w-[4rem] h-[4rem] border border-[#111111] rounded-[0.7rem] p-[1rem] flex justify-center items-center">
                    <img
