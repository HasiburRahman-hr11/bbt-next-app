...
const styles = {
  tabMenu:
    "text-center text-[1.2rem] border border-[#D2D2D2] rounded-[3rem] leading-[1] px-[1.6rem] py-[0.7rem] block mr-[0.6rem] mt-[0.8rem] xl:text-[1.4rem] xl:px-[2rem] xl:py-[1rem] xl:mx-[0.7rem] 1xl:text-[1.6rem] 2xl:text-[1.8rem] 2xl:px-[2.3rem] 2xl:py-[1.2rem] 3xl:text-[2.19rem] 3xl:px-[2.8rem] 3xl:py-[1.7rem] 3xl:mx-[0.8rem] 1xl:min-w-[8rem] 3xl:min-w-[10rem] cursor-pointer",
  tabListItem:
    "relative before:content-[''] before:absolute before:left-0 before:top-[50%] before:translate-y-[-50%] before:w-[0.7rem] before:h-[1px] pl-[2.5rem] xl:before:w-[1rem] xl:before:h-[2px] xl:pl-[2rem] before:bg-black 1xl:text-[1.8rem] 2xl:before:w-[1.3rem] 2xl:before:h-[2.5px] 2xl:text-[2rem] 3xl:text-[2.4rem] 3xl:before:w-[1.5rem] 3xl:before:h-[3px] 3xl:pl-[3rem] font-light",
  tabBtn:
    "bg-black w-full text-white text-center text-[1.4rem] flex justify-center items-center rounded-[3rem] px-[3rem] h-[5rem] xl:text-[1.2rem] 1xl:h-[5.5rem] 1xl:text-[1.3rem] 2xl:text-[1.4rem] 3xl:text-[1.8rem] 2xl:h-[6rem] 2xl:rounded-[4rem] 3xl:h-[7.3rem] transition-all duration-500 hover:bg-[#333]",
  tabContentItem:
    "bg-white py-[3rem] px-[3rem] rounded-[1rem] mt-[3rem] xl:mt-[4rem] 3xl:mt-[5rem] xl:py-[5rem] xl:pl-[6rem] xl:pr-[4rem] 3xl:py-[6rem] 3xl:pl-[7rem] 3xl:pr-[5rem] 3xl:rounded-[1.5rem]",
    tabContentIcon:"object-contain h-auto w-[3.5rem] 1xl:w-[4.5rem] 3xl:w-[5.5rem]",
    tabContentTitle:"font-normal 1xl:text-[3.5rem] 1xl:tracking-tighter 2xl:text-[3.8rem] 3xl:text-[4.5rem]",
};
        ...
        <div className="container">
          ...
          >
            <div className="flex justify-between flex-wrap">
              ...
              <div className="w-max xl:min-w-[150px] 2xl:min-w-[170px] 3xl:min-w-[214px]">
                <a href="#" className={styles.tabBtn}>
                  Book Now
                </a>
              </div>
            </div>
            <div className="xl:pl-[5.5rem] xl:pr-[3rem] xl:py-[2rem] 1xl:pl-[7rem] 3xl:pl-[9rem] 3xl:pr-[5rem] 3xl:py-[2rem]">
              <h4 className=" 1xl:text-[2.6rem] 3xl:text-[3.5rem] tracking-tighter font-normal">
                Includes
              </h4>
              <ul className="xl:mt-[1.5rem] 3xl:mt-[2rem]">
              ...
              <p className="xl:text-[1.3rem] xl:mt-[2rem] 1xl:text-[1.4rem] 2xl:text-[1.5rem] 3xl:text-[1.9rem] 3xl:mt-[3rem]">
          ...
          >
            ...
            <div className="xl:pl-[5.5rem] xl:pr-[3rem] xl:py-[2rem] 1xl:pl-[7rem] 3xl:pl-[9rem] 3xl:pr-[5rem] 3xl:py-[2rem]">
              ...
              <p className="xl:text-[1.3rem] xl:mt-[2rem] 1xl:text-[1.4rem] 2xl:text-[1.5rem] 3xl:text-[1.9rem] 3xl:mt-[3rem]">
                ...
                your car leaves our workshop looking as good as new. <br />{" "}
                <br />
