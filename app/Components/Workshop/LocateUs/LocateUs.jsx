...
const LocateUs = () => {
  return (
    <section className="bg-white">
      <div className="max-1920 relative pl-[10rem] 3xl:pl-[20rem] py-[5rem]">
        <div>
          <img
        ...
        <div className="absolute top-0 left-0 w-full h-full py-[5rem] sm:py-[8rem] md:pb-[12rem] lg:pb-[15rem] xl:py-[12rem] 1xl:pt-[14rem] 3xl:py-[18rem]">
            ...
            <div className="flex flex-wrap">
              <div className="w-[41%]">
                <div className="xl:max-w-[270px] 1xl:max-w-[295px] 2xl:max-w-[300px] 3xl:max-w-[403px]">
                  ...
                  <p className="font-[300] text-[1.2rem] leading-[1.5] lg:text-[1.1rem] lg:tracking-tight xl:mt-[1rem] xl:text-[1.13rem] xl:leading-[1.5] 1xl:text-[1.28rem] 2xl:text-[1.3rem] 3xl:text-[1.6rem] 3xl:leading-[1.5] 3xl:tracking-[0] [&>b]:font-[500] 3xl:mt-[2rem]">
                  ...
                  <div className="w-max xl:mt-[4rem] xl:min-w-[170px] 2xl:min-w-[190px] 3xl:min-w-[240px] 3xl:mt-[6rem]">
                    <a
              ...
              <div className="xl:w-[26%] pt-[5rem]">
                <div className="bg-white p-[0.5rem] 1xl:p-[0.8rem] 3xl:p-[1rem] rounded-[1rem] 3xl:rounded-[1.5rem] shadow-xl">
                  ...
                  <div className="px-[2rem] py-[2rem] 3xl:px-[3rem]">
                    ...
                    <ul className="xl:mt-[2rem] 3xl:mt-[3rem]">
                        <li className="flex items-center xl:py-[0.6rem] 3xl:py-[0.8rem]">
                            <img src="/images/workshop/phone-icon.webp" alt="Phone Icon" className="w-[1.5rem] 3xl:w-[1.8rem] h-auto object-contain" />
                            <span className="xl:text-[1.1rem] 1xl:text-[1.3rem] xl:tracking-tight 2xl:text-[1.4rem] 3xl:text-[1.6rem] inline-block ml-[1rem]">(+91) 9999 9999 83</span>
                        </li>
                        <li className="flex items-center xl:py-[0.6rem] 3xl:py-[0.8rem]">
                            <img src="/images/workshop/clock-icon.webp" alt="Phone Icon" className="w-[1.5rem] 3xl:w-[1.8rem] h-auto object-contain" />
                            <span className="xl:text-[1.1rem] 1xl:text-[1.3rem] xl:tracking-tight 2xl:text-[1.4rem] 3xl:text-[1.6rem] inline-block ml-[1rem]">We are happy to help (10am to 10pm)</span>
                        </li>
                    </ul>
                  </div>
                </div>
