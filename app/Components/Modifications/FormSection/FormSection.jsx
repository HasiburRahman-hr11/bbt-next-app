          ...
          <div>
            <form action="" className="w-full block mt-[3rem]" onSubmit={handleSubmit}>
              ...
              <div className="mt-[2rem]">
                <button
                  type="submit"
                  className="w-full block border border-[#333333] rounded-[5px] py-[1.2rem] bg-black text-white text-[1.4rem] outline-none"
                >
                  Submit
                </button>
              </div>
...
const styles = {
  inputStyle:
    "w-full block border border-[#333333] rounded-[5px] py-[1.2rem] pl-[1.5rem] text-[1.4rem] outline-none",
};
