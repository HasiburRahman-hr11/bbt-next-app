  ...
  return (
    <div className="bg-[#131313] px-[2rem] pt-[2.5rem] pb-[5rem] overflow-hidden relative text-white rounded-[1rem] my-[1rem] xl:pb-[7rem] xl:pl-[3rem] 1xl:px-[3rem] 2xl:pt-[3.5rem] 3xl:pt-[5rem] 3xl:pb-[9rem] 3xl:pl-[4rem]">
      ...
      <h4
        ...
        className="text-[1.5rem] mt-[3rem] font-light [&>b]:font-medium xl:text-[1.9rem] xl:mt-[5rem] 1xl:text-[2.2rem] 2xl:text-[2.5rem] 3xl:text-[3rem] 1xl:mt-[6rem] 3xl:mt-[8rem] xl:leading-[1.3]"
      ></h4>
      ...
      <div className="max-1920">
        <div className="container">
          ...
          {processData && processData.length > 0 && (
            <div className="grid grid-cols-2 gap-x-[1.5rem] mt-[3rem] max-w-[450px] mx-auto md:max-w-none md:grid-cols-4 lg:w-[90%] xl:mt-[5rem] xl:gap-x-[3.5rem] xl:w-[88%] 1xl:gap-x-[4rem] 1xl:mt-[7rem] 3xl:mt-[9rem] 3xl:gap-x-[6rem]">
