  ...
  return (
    <div className="py-28 hidden lg:block bg-white accordion-box xl:py-40 2xl:py-48">
      <div className="container">
        <h6 className="font-medium text-3.5rem mb-20 xl:text-4xl xl:mb-16 1xl:text-4.5xl 1xl:tracking-tighter 2xl:mb-20 3xl:text-5.5xl 3xl:mb-28">Full Specification</h6>
            ...
            >
              ...
              >
                <div className="flex items-center w-max">
                  ...
                  />
                  <p className="font-medium text-3xl 1xl:text-3.5xl 1xl:tracking-tight 2xl:text-4xl 3xl:text-4.5xl">{item.title}</p>
                </div>
                <div className="w-max">
                  <Image
