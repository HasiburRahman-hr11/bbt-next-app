...
const PlatformSection = () => {
  return (
    <section className="bg-[#F4F4F1] py-[6rem] md:py-[8rem] lg:py-[10rem] xl:py-[14rem]">
      <div className="max-1920">
        <div className="container">
          <div className="flex flex-col mx-auto max-w-[400px] md:w-full md:max-w-none md:flex-row md:justify-between">
            <div className="md:w-[50%] xl:w-[47%]">
              <h2 className="font-light leading-[1.2] tracking-tighter mt-[1rem] text-center md:text-left [&>br]:hidden text-black md:[&>br]:block xl:text-[3.9rem] xl:leading-[1.2] xl:tracking-[-1.8px] 1xl:text-[4.5rem] 1xl:tracking-[-3px] 1xl:leading-[1.2] 2xl:text-[4.6rem] 3xl:text-[5.8rem] 3xl:leading-[1.1] capitalize">
                we have create <br /> <b>a platform to excel</b>
              </h2>
              <p className="text-[1.2rem] text-center md:text-left mt-[2rem] xl:text-[1.3rem] 1xl:text-[1.4rem] 3xl:text-[1.9rem] font-light [&>br]:hidden lg:[&>br]:block">
                BBT believes that its future depends on its people who are
                capable <br /> enough to generate new ideas & plans that
                altogether will help in <br /> talking the business to a new
                height.
              </p>
              ...
              <ul className="grid grid-cols-2 gap-x-[2rem] gap-y-[1.5rem] mt-[4rem] xl:gap-x-[4rem] xl:gap-y-[3rem] xl:mt-[6rem]">
                {usps.map((usp, index) => (
                  <li
                    key={index}
                  ...
                  >
                    ...
                    <div className="mt-[1rem] xl:mt-[2rem]">
                      <h6
                        className="text-[1.1rem] font-light capitalize [&>b]:font-medium sm:text-[1.3rem] xl:text-[1.5rem] 1xl:text-[1.7rem] 3xl:text-[2.4rem]"
