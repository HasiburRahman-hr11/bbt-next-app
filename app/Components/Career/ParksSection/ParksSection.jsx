...
const parks = [
  ...
  },
  {
    ...
    title: "Tranquil Work <b> Environment</b>",
  },
  {
              ...
              >
                <div className="flex items-center md:flex-col md:justify-start md:items-start">
                  ...
                  <div className="flex-[1] pl-[1rem] sm:pl-[1.5rem] md:w-full md:pl-0 md:mt-[1rem] xl:mt-[3rem] 1xl:mt-[4rem] 3xl:mt-[7rem]">
                    <h6
                      className="text-[1.1rem] font-light capitalize [&>b]:font-medium [&>b]:block sm:text-[1.3rem] xl:text-[1.5rem] 1xl:text-[1.7rem] 2xl:text-[1.9rem] 3xl:text-[2.4rem]"
