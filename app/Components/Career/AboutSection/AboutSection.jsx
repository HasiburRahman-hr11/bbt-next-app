            ...
            <div className="w-full md:w-[50%] xl:w-[47%] 1xl:w-[45%]">
              <div className="mt-[4rem] w-full md:mt-0">
                <p className="text-[1.2rem] text-center md:text-left xl:text-[1.3rem] 1xl:text-[1.4rem] 2xl:text-[1.48rem] 3xl:text-[1.9rem] font-light">
                  Among the many technical jargons that you keep on hearing
                  about the automobile, the one that comes up repeatedly in the
                  conversation is about torque vectoring. Today we will like to
                  demystify this term and tell you what it means and why it is
                  so important. Our Vision is to grow along with the team to be
                  ...
                  jargons. Imagine working with supercars where every detail
                  matters, from engines with immense power to fascinating
                  aerodynamic designs that set new standards for speed and
                  performance. Here, your passion for cars meets a dynamic team
                  of like-minded individuals. Join our team and be part of a
                  world where your love for technical precision and
                  high-performance vehicles meets unmatched career
                  opportunities. If you live and breathe cars, this is the place
                  for you. Let’s drive the future together!
                </p>
              </div>
