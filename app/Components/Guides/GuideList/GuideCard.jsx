...
const GuideCard = ({ data }) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-full px-[4rem] py-[4rem] sm:py-[6rem] sm:px-[6rem] md:py-[4rem] md:px-[4rem] xl:px-[3rem] 1xl:py-[5rem] 2xl:pl-[4rem] flex flex-col justify-end 3xl:pb-[7rem] 3xl:pl-[5rem]">
