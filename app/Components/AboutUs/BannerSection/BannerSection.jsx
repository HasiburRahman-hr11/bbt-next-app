        ...
        <div className="container relative z-10">
          <div className="lg:flex lg:justify-between">
            <div className="lg:w-[40%]">
              <div className="hidden lg:block ">
                <p className="flex flex-wrap items-center font-light">
                  <Link
                    href="/"
            ...
            <div className="lg:w-[53%]">
              <p className="text-[1.2rem] font-medium mt-[1rem] md:text-[1.4rem] xl:text-[1.85rem] leading-[1.35] 1xl:text-[2.05rem] 2xl:text-[2.2rem] 3xl:text-[2.8rem]">
          ...
          <div className="relative mt-[2.5rem] mb-[4rem] lg:mt-[4rem] xl:mt-[6.5rem] xl:mb-[8.5rem] 1xl:mt-[8rem] 2xl:mb-[9.5rem] 3xl:mb-[12rem]">
            ...
            <video
              ...
              poster="/images/about-us/about-video-thumb-desktop.webp"
              ref={videoRef}
            ></video>
            <div
          ...
          <div className="relative z-10">
            <h2 className="font-light [&>b]:font-normal tracking-[-2px] leading-[1.1] pb-[2.5rem] mb-[2.5rem] border-b border-b-black [&>br]:hidden lg:[&>br]:block xl:text-[4rem] xl:tracking-[-2.5px] xl:pb-[4rem] xl:mb-[4rem] 1xl:text-[4.5rem] 1xl:tracking-[-3px] 1xl:pb-[6rem] 2xl:text-[4.8rem] 3xl:text-[5.8rem] 3xl:mb-[5rem] 3xl:pb-[7rem]">
              Big boy toyz, a <b>pre-owned luxury car <br /> dealer deals with 24 brands.</b>
            </h2>
            <div className="[&>p]:font-light [&_b]:font-[500] [&>p]:text-[1.2rem] [&>p]:leading-[1.3] md:[&>p]:text-[1.4rem] lg:flex lg:justify-between xl:[&>p]:text-[1.13rem] xl:[&>p]:leading-[1.4] 1xl:[&>p]:text-[1.23rem] 3xl:[&>p]:text-[1.6rem]">
              <h5 className="hidden lg:block lg:w-max xl:text-[1.7rem] 3xl:text-[2.5rem] xl:w-[21%] font-medium tracking-tighter 1xl:text-[1.9rem] 3xl:font-[600] 3xl:w-[23%]">About Company</h5>
