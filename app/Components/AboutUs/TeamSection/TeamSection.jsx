          ...
          <div className="lg:flex flex-wrap justify-between items-center">
            ...
            <div className="lg:w-[30%] 3xl:w-[29%]">
              ...
              <div className="mt-[3rem] max-w-[310px] mx-auto hidden lg:block lg:ml-0 3xl:mt-[5rem]">
                <Link
                  href="/team"
                  className="bg-black text-white text-center text-[1.4rem] flex justify-center items-center rounded-[3rem] h-[5rem] xl:w-max xl:px-[4rem] xl:text-[1.2rem] 1xl:h-[5.5rem] 1xl:text-[1.3rem] 1xl:px-[7rem]  2xl:text-[1.4rem] 3xl:text-[1.8rem] 2xl:h-[6rem] 2xl:rounded-[4rem] 3xl:h-[7.3rem]"
                >
                  Meet Our Team
                </Link>
              </div>
