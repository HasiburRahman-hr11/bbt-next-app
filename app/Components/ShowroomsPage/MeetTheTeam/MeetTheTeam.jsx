    ...
    <section>
      <div className="max-1920 relative">
        ...
        <div className="hidden sm:block">
          <img
            src="/images/showroom-page/team-bg-desktop.webp"
            alt="Background Image"
          ...
          <div className="container w-full h-full">
            <div className="flex h-full w-full flex-col justify-between py-[6rem] sm:justify-center">
              <div className="text-center text-white sm:text-left">
                <p className="text-[1.12rem] uppercase font-light xl:hidden">BBt Squad</p>
