...
const CollectionItem = () => {
  return (
    ...
    >
      <div
        className={`bg-white px-8 pt-[2rem] pb-[2rem] sm:px-8 sm:pt-8 sm:pb-16 lg:pb-10 2xl:py-10 3xl:px-20 3xl:pt-12 3xl:pb-16 1xl:px-12 `}
      >
        <p
        ...
        <ul className="flex flex-wrap mt-8">
          ...
          <li className="w-3/6 px-7 border-l border-[#CFCFCF] last-of-type:border-r">
            <Image
              ...
              className={`object-contain h-5 3xl:h-6 3xl:w-6 `}
            />
            <p className="text-[1.1rem] tracking-[-0.5px] mt-4 mb-2">Fuel / Gas Type</p>
