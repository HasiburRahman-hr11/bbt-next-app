    ...
    <section className="bg-white py-[6rem] lg:py-[8rem] xl:py-[12rem] 1xl:py-[14rem] 3xl:py-[18rem]">
      <div className="max-1920">
        <div className="container">
          ...
          <div className="flex flex-wrap justify-between mt-[6rem] xl:mt-[8rem] 1xl:mt-[10rem]">
            <div className="w-full md:w-[40%] lg:w-[45%] pt-[5rem]">
              ...
              <div className="mt-[4rem] hidden md:block">
                <a
                  href="#"
                  className="w-max h-[4.5rem] flex justify-center items-center text-[1.2rem] bg-black text-white px-[3rem] py-[1rem] rounded-[3rem] xl:px-[4.5rem] xl:h-[5rem] xl:text-[1.2rem] 1xl:h-[5.5rem] 1xl:text-[1.3rem] 2xl:h-[5.5rem] 3xl:h-[6.5rem] 2xl:text-[1.4rem] 3xl:text-[1.8rem] 3xl:rounded-[4rem] 3xl:px-[8rem] hover:bg-[#333333] transition-all duration-500 ease-in-out"
                >
                  Schedule Call
                </a>
              </div>
            ...
            <div className="w-full mt-[4rem] sm:max-w-[450px] sm:mx-auto md:max-w-none md:mr-0 md:w-[42%] md:mt-0 lg:w-[40%] xl:w-[45%]">
              <ul className="grid grid-cols-3 gap-[1rem] auto-rows-fr xl:gap-x-[4rem] xl:gap-y-[2rem] 3xl:gap-x-[5.5rem] 3xl:gap-y-[3rem]">
                {partners.map((item, index) => (
                  <li
                    key={index}
                    className="rounded-[0.5rem] border border-[#AEAEAE] p-[1rem] flex justify-center items-center xl:rounded-[1.5rem] xl:p-[1.5rem] 3xl:h-[200px] 3xl:rounded-[2rem] xl:p-[2rem]"
                  >
                    <img
                      src={item.logo}
                      alt="logo"
