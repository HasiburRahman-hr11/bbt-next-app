        ...
        <div className="container">
          <div className="flex flex-wrap justify-between">
            <div className="w-full text-center mb-[4rem] lg:w-[50%] lg:mb-0 lg:text-left">
              ...
              <h1 className="font-[200] text-[4.5rem] [&>b]:font-[400] leading-[1.2] tracking-[-0.2rem] lg:text-[5rem] 1xl:text-[6rem] 1xl:tracking-[-0.4rem] 2xl:text-[6.3rem] 3xl:text-[7.5rem] 2xl:tracking-[-0.5rem]">
                Lamborghini <br /> <b>Aventador SVJ</b>
              </h1>
            </div>
            <div className="w-full lg:w-[42%] border-t border-[#ddd] pt-[4rem] lg:border-none lg:pt-0">
              <h3 className="text-[2.2rem] mb-[1rem] text-center lg:text-left xl:text-[3.5rem] 1xl:text-[3.9rem] 2xl:text-[4.2rem] 3xl:text-[4.5rem] 3xl:mb-[2rem]">Work Done</h3>
