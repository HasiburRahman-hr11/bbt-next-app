...
const styles = {
    inputStyles:'w-full bg-transparent border border-[#AAAAAA] outline-none rounded-[0.7rem] text-[1.5rem] 1xl:text-[1.5rem] 2xl:text-[1.6rem] 3xl:text-[1.8rem] px-[1rem] py-[1rem] h-[5rem] 1xl:h-[5.5rem] 2xl:h-[6rem] 3xl:h-[7rem] 1xl:rounded-[1rem] 1xl:px-[2rem]',
    buttonStyle: 'w-full bg-black text-white border border-black outline-none rounded-[0.7rem] text-[1.5rem] 1xl:text-[1.5rem] 2xl:text-[1.6rem] 3xl:text-[1.8rem] px-[1rem] py-[1rem] h-[5rem] 1xl:h-[5.5rem] 2xl:h-[6rem] 3xl:h-[7rem] 1xl:rounded-[1rem] hover:bg-[#111111]'
}
