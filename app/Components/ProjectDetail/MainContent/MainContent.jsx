          ...
          <div className="flex flex-wrap justify-between">
            <div className="w-full lg:w-[60%] 1xl:w-[65%] 2xl:w-[68%]">
              ...
              <div className="relative">
                <video
                  src="/images/project-detail/lambo-video.mp4"
                  className="w-full h-full object-cover rounded-[1.5rem] md:rounded-[2.5rem] 1xl:rounded-[3rem]"
                  playsInline
                  muted
                  loop
              ...
              {detailImages.map((item, index) => (
                <div
                  className="relative rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden mt-[2rem] 1xl:mt-[2.5rem] 2xl:mt-[3rem] 1xl:rounded-[3rem]"
                  key={index}
                >
                  <img
                    src={item.image}
              ...
              <div className="md:flex md:flex-wrap md:justify-between lg:block lg:sticky lg:top-[4rem]">
                ...
                <div className="bg-black px-[3.5rem] py-[4.5rem] rounded-[2rem] text-white mt-[4rem] md:w-[48%] lg:w-full md:mt-0 md:h-[inherit] lg:mt-[4rem] 1xl:py-[5.5rem] 2xl:px-[4.5rem] 3xl:px-[5rem] 1xl:rounded-[3rem] 1xl:pb-[7rem]">
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="mailto:sales@bigboytoyz.com"
                        className="flex w-full items-center"
                      >
                        <div className="w-[4rem]">
                          <img
                            src="/images/project-detail/message-icon.webp"
                            alt="Call Icon"
                            className="w-full object-contain"
                          />
                        </div>
                ...
                {/* Quote */}
                <div className="bg-[#F6F6F6] px-[3.5rem] py-[4.5rem] rounded-[2rem] text-[#313131] mt-[4rem] w-full 1xl:py-[5.5rem] 2xl:px-[4.5rem] 3xl:px-[5rem] 1xl:rounded-[3rem]">
                  <img
...
const styles = {
  ...
  submitStyle:
    "bg-[#404040] border border-[#404040] text-[1.2rem] xl:text-[1.4rem] 1xl:text-[1.5rem] 3xl:text-[1.6rem] px-[1rem] py-[0.5rem] w-full h-[4.5rem] xl:h-[5rem] 1xl:h-[5.5rem] 2xl:h-[6rem] 3xl:h-[6.5rem] outline-none rounded-[0.7rem] 1xl:rounded-[1rem] 2xl:px-[2rem]",
};
