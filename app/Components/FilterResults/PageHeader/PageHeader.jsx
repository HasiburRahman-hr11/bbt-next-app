            ...
            <div className="flex flex-wrap items-center lg:flex-row-reverse">
              <div className="flex flex-wrap items-center ">
                <div className="md:flex cursor-pointer md:items-center lg:mx-[2rem] lg:px-[2rem] lg:border-x lg:border-[#D9D9D9] 1xl:px-[2.5rem] 1xl:mx-[2.5rem] 3xl:px-[3.5rem] 3xl:mx-[3.5rem]">
                  ...
                  <div
                    className="w-[2.3rem] h-[2.3rem] p-[0.3rem] border border-[#E0E0E0] rounded-[5px] md:w-[4rem] md:h-[4rem] md:p-[1rem] xl:w-[4rem] xl:h-[4rem] 1xl:w-[4.3rem] 1xl:h-[4.3rem] 3xl:w-[5.6rem] 3xl:h-[5.6rem] flex justify-center items-center"
                    onClick={togglePopup}
                  >
                    <Image
