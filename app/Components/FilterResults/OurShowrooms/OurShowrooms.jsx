      ...
      <div className="max-1920 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="container w-full h-full">
            <div className="flex h-full w-full flex-col justify-between py-[6rem] sm:justify-start xl:pt-[7rem]">
              <div className="text-center text-white">
                <p className="text-[1.4rem] uppercase font-light xl:text-[1.37rem] 1xl:text-[1.4rem] 2xl:text-[1.8rem] 3xl:text-[2.2rem]">
                  Enhanced Customer Journey
                </p>
                <h2 className="font-light [&>b]:font-normal leading-[1.2] mt-[1.5rem] tracking-[-2px] text-[2.9rem] xl:text-[3.75rem] 1xl:text-[4.2rem] 2xl:text-[5rem] 3xl:text-[5.8rem]">
