...
const CooSection = () => {
  return (
    <section className="bg-white py-[4rem] sm:py-[8rem] 2xl:py-[14rem]">
          ...
          <div className="sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:flex-row-reverse">
            ...
            <div className="sm:w-[50%] lg:w-[42%]">
              <div className="hidden sm:block">
                <h2 className="text-[2.8rem] tracking-[-1.5px] lg:text-[3rem] lg:font-[400] 1xl:text-[3.3rem] 2xl:text-[3.5rem] 3xl:text-[4.5rem]">
                  Mrs. Ritika Jatin Ahuja
                </h2>
              ...
              <p className="font-light text-[1.2rem] leading-[1.4] mt-[2rem] lg:text-[1.1rem] lg:tracking-tight xl:text-[1.13rem] xl:leading-[1.4] 1xl:text-[1.28rem] 2xl:text-[1.4rem] 3xl:text-[1.6rem]">
