...
const styles = {
  uspItem:
    "w-[33%] px-[1.5rem] rounded-[0.7rem] overflow-hidden md:w-[10rem] md:h-[10rem] md:mx-0 md:px-0 md:mb-[2rem] lg:w-[12rem] lg:h-[12rem] lg:mb-0 last-of-type:mb-0 xl:w-[14rem] xl:h-[14rem] 1xl:w-[16rem] 1xl:h-[16rem] 2xl:w-[17rem] 2xl:h-[17rem] 3xl:w-[18.9rem] 3xl:h-[18.9rem]",
};
    ...
    <section className="bg-black">
      <div className="max-1920 relative">
        <div className="sm:hidden">
          <img
            src="/images/team-old/team-banner-mobile.webp"
        ...
        <div className="hidden sm:block">
          <img
            src="/images/team-old/team-banner-desktop.webp"
            alt="Background Image"
        ...
        <div className="absolute top-0 left-0 w-full h-full py-[6rem] md:py-[8rem] xl:py-[12rem] 1xl:py-[14rem] 2xl:py-[16rem] 3xl:py-[20rem]">
          <div className="container h-full">
            <div className="flex flex-col flex-wrap justify-between h-full">
              ...
              <div className="w-full md:w-max ml-auto md:h-full">
                <div className="flex flex-wrap justify-center max-w-[400px] mx-auto md:flex-col md:w-max md:ml-auto md:h-full md:justify-between">
