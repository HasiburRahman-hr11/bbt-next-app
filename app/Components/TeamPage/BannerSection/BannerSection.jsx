  ...
  return (
    <section className="bg-[#1B1A1D] text-white relative">
      <div className="max-1920 relative">
        ...
        />
        <div className="absolute top-0 left-0 h-full w-full text-center pt-[10rem] pb-[7rem] flex flex-col justify-between sm:pt-[7rem] md:pb-[5rem] lg:pt-[12rem] lg:pb-[7rem] xl:pt-[10rem] 1xl:pt-[12rem] 2xl:pt-[13rem] 3xl:pt-[17rem] 3xl:pb-[10rem]">
          <div
            data-aos="fade-down"
