  ...
  return (
    <ul className={`flex ${styles.newIncUsp} ${isDetailPage ? styles.detailInfoUsp :''} `}>
      <li className="w-2/6">
        ...
        />
        <p className="text-base mt-4 mb-2 lg:mt-2 lg:mb-1 lg:text-sm 3xl:text-xl 3xl:mt-4 3xl:mb-3">
          Kilometers Driven
        </p>
        <h6 className="text-lg 3xl:text-1xl"> {data?.kmDriven ? data.kmDriven : '0'} km</h6>
      </li>
      <li className="w-2/6">
        <Image
