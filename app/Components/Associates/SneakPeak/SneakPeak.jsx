...
const SneakPeak = () => {
  return (
    <section className="bg-white py-[6rem] lg:py-[10rem]">
      <div className="max-1920">
        <div className="container">
          <div className="flex flex-col lg:flex-row lg:flex-wrap lg:items-end">
            <div className="text-center lg:w-[50%] lg:text-left">
              <h2 className="font-light leading-[1.2] tracking-tighter mt-[1rem]  [&>br]:hidden text-black md:[&>br]:block xl:text-[3.9rem] xl:leading-[1.2] xl:tracking-[-1.8px] 1xl:text-[4.5rem] 1xl:tracking-[-3px] 1xl:leading-[1] 2xl:text-[4.6rem] 3xl:text-[5.8rem] 3xl:leading-[1.1] capitalize">
          ...
          <div className="masonry sm:masonry-sm md:masonry-md mt-[5rem]">
            {data.map((item, index) => (
              <div
                className="rounded-[1rem] break-inside mb-[2rem] overflow-hidden"
                key={index}
              >
                <img
                  src={item.image}
          ...
          <div className="md:mt-[4rem] xl:mt-[5rem]">
...
const styles = {
  socialItem:
    "flex items-center py-[0.7rem] px-[1rem] rounded-[3rem] bg-[#F3F3F3] min-w-[13rem] mr-[1rem] md:mr-0 md:ml-[1.5rem]",
  socialIconWrapper:
    "bg-black flex items-center justify-center w-[3rem] h-[3rem] rounded-[50%] p-[0.7rem]",
  socialIconImg: "w-full h-auto object-contain max-h-[1.6rem]",
  socialTitle: "font-light text-[1.3rem] flex-[1] pl-[1rem]",
  paginationList:
