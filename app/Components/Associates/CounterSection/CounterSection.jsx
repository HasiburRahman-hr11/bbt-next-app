...
const CounterSection = () => {
  return (
    <section className="bg-[#F3F3F3] py-[6rem] lg:py-[10rem] xl:py-[12rem]">
        ...
        <div className="container">
          <div className="flex flex-col md:max-w-[600px] md:mx-auto lg:max-w-none lg:flex-row lg:flex-wrap lg:justify-between">
            <div className="lg:w-[40%] xl:w-[37%]">
              <h2 className="font-light leading-[1.2] tracking-tighter mt-[1rem] text-center lg:text-left [&>br]:hidden text-black md:[&>br]:block xl:text-[3.9rem] xl:leading-[1.2] xl:tracking-[-1.8px] 1xl:text-[4.5rem] 1xl:tracking-[-3px] 1xl:leading-[1] 2xl:text-[4.6rem] 3xl:text-[5.8rem] 3xl:leading-[1.1] capitalize">
            ...
            <div className="lg:w-[50%] xl:w-[45%]">
                <ul className="grid grid-cols-2 gap-x-[2rem] gap-y-[1rem] mt-[4rem] xl:gap-x-[3rem] xl:pt-[4rem] xl:gap-y-[1.5rem]">
                    {usps.map((usp,index)=>(
