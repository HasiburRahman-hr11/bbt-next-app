          ...
          <div className=" text-center absolute w-full h-full left-0 top-0 flex flex-col justify-between pt-[12rem] pb-16 sm:text-left sm:pt-[15rem] md:pt-[18rem] lg:pt-[20rem] xl:pt-[25rem] 1xl:pt-[29rem] 2xl:pt-[33rem] 3xl:pt-[40rem] 3xl:pb-[6rem]">
            ...
            >
              ...
              <div className="flex items-center w-max">
                <a
                  href="#"
                  className="hidden sm:flex items-center bg-white text-black w-max h-[6.5rem] px-[2rem] rounded-[0.5rem]"
                >
                  <img
                ...
                <div className="fixed w-full bottom-0 left-0 bg-white flex py-[2rem] px-[2rem] items-center justify-center z-10">
                  <a
                    href="tel:+919999999915"
                    className="flex items-center justify-center bg-white text-black w-max h-[5rem] px-[2rem] rounded-[0.5rem] mr-[1.5rem] shadow-[0_11px_60px_-10px_rgba(0,0,0,0.4)]"
                  >
                    <img
                      src="/images/sell-your-car/banner-call-iocn.webp"
                      alt="Call Icon"
                      className="w-[1.9rem] object-contain h-auto"
                    />
                    <p className="flex-[1] pl-[1rem] text-[1.5rem] font-medium">
                      Call Now : 9999 9999 15 
                    </p>
                  </a>
                  <a
                    href="#"
                    className="w-[5rem] h-[5rem] bg-[#1BD741] flex items-center justify-center rounded-[0.7rem] shadow-[0_11px_60px_-10px_rgba(0,0,0,0.4)]"
                  >
                    <img
                      src="/images/sell-your-car/banner-whatsapp-icon.webp"
                      alt="Call Icon"
                      className="w-[2.7rem] object-contain h-auto"
                    />
                  </a>
                </div>
              </div>
