    ...
    <section className="text-white bg-black">
      <div className="max-1920">
        <div className="relative">
          ...
          <div className=" text-center absolute w-full h-full left-0 top-0 flex flex-col justify-between pt-[12rem] pb-16 sm:text-left sm:pt-[15rem] md:pt-[18rem] lg:pt-[19rem] 1xl:pt-[22rem] 2xl:pt-[24rem] 3xl:pt-[27rem] 3xl:pb-[6rem]">
            <div
                ...
                <div className="fixed w-full bottom-0 left-0 bg-white flex py-[2rem] px-[2rem] items-center justify-center z-10 sm:static sm:bg-transparent sm:py-0 sm:px-0 sm:ml-[1.5rem] sm:w-max">
                  ...
                  >
                    <img
                      ...
                      alt="Call Icon"
                      className="w-[2.7rem] object-contain h-auto xl:w-[2rem]"
                    />
                  </a>
                </div>
              </div>
