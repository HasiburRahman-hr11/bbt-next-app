      ...
      <div className="max-1920">
        <div className="container">
          <div className="text-center text-white lg:text-left">
            ...
            <div className="lg:hidden mt-[5rem]">
                <img src="/images/sell-your-car/presence-map.webp" alt="" className="block w-full h-auto object-contain" />
            </div>

            <div className="mt-[5rem] xl:mt-[5.5rem] 3xl:mt-[8rem]">
              <Link
                href="/showrooms"
                className="w-max mx-auto h-[4.5rem] flex justify-center items-center text-[1.2rem] bg-white text-black px-[3rem] py-[1rem] rounded-[3rem] xl:px-[4.5rem] xl:h-[5rem] xl:text-[1.2rem] 1xl:h-[5.5rem] 1xl:text-[1.3rem] 2xl:h-[5.5rem] 3xl:h-[7.3rem] 2xl:text-[1.4rem] 3xl:text-[1.8rem] 3xl:rounded-[4rem] 3xl:px-[8rem] hover:bg-[#333333] transition-all duration-500 ease-in-out"
              >
                View Our Showrooms
              </Link>
            </div>
