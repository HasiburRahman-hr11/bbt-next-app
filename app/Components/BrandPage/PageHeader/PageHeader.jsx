  ...
  return (
    <section className="bg-white md:bg-[#f3f3f3]">
      <div className="container">
        <div className="">
          <p className="text-center font-light py-16 text-[1.3rem] leading-[1.5]">
            Tired of looking for a classy used BMW car? Are dealers striking
            your wallet down with mediocre content? Worry no more! BBT brings to
            you pre-owned and used BMW cars with an efficient price.
          </p>
          <div className="flex flex-wrap items-center justify-between py-12 border-b border-t border-neutral-[#D9D9D9]">
