...
const uspList = [
  {
    title: "5 Series",
    description:
      "It was initially started as sedans, later they advanced the body style like Wagon/estate. Now you have the 5 series with a timeless design and 233km/h of top speed. It is built with advanced technology, Active Hybrid, which saves fuel and reduces emissions by 10%. Also, the top model of the 5 series, 530d M Sport a 2993 cc, carries 8-speed automatic transmission. The model is developed with smart features and more safety measures.",
    link: "#",
  },
  {
    title: "6 Series",
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-[1.3rem] font-light [&>strong]:font-medium [&>b]:font-medium xl:text-[1.8rem] xl:leading-[1.6] 1xl:text-[2.2rem] 3xl:text-[2.8rem]">
              ...
              advanced and innovative timely. Also, it comes under the top 3 in
              the list of best brands in the world. BMW has excelled in the
              competition in India, however, Big Boy Toyz has got the best used
              BMW cars in India at a competitive price range.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[1.3rem] font-light [&>strong]:font-medium [&>b]:font-medium xl:text-[1.8rem] xl:leading-[1.6] 1xl:text-[2.2rem] 3xl:text-[2.8rem]">
              ...
              on point. Check out the best match for you from the used BMW brand
              series.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[1.3rem] font-light [&>strong]:font-medium [&>b]:font-medium xl:text-[1.8rem] xl:leading-[1.6] 1xl:text-[2.2rem] 3xl:text-[2.8rem]">
              ...
              make their wish come true by owning a BMW car. So Big Boy Toyz is
              here to complete your dream of purchasing top-quality used BMW
              cars. We have a wide range of series at an affordable price range,
              choose the best suitable for you!
            </p>
          </div>
