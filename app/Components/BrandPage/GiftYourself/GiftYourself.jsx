    ...
    <section className="bg-[#F6F6F6] py-24 xl:py-36 3xl:py-[15rem]">
      <div className="max-1920">
        <div className="container">
          ...
          >
            <h2 className="text-[2.9rem] font-medium leading-[1.1] mb-8 xl:text-[3.4rem] 1xl:text-[4rem] 1xl:mb-14 3xl:text-[4.5rem]  md:[&_br]:hidden">
              Gift Yourself <br />
              The Best Used Bmw!
            </h2>
            <p className="text-[1.3rem] font-normal [&>strong]:font-medium [&>b]:font-medium xl:text-[1.8rem] xl:leading-[1.6] 1xl:text-[2.2rem] 3xl:text-[2.8rem]">
