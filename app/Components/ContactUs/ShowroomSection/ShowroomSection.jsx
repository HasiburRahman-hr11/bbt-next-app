...
const showrooms = [
  ...
  {
    title: "Ludhiana <br/>Studio",
    address:
      "1st Floor, Lake Street, Ferozepur - Ludhiana Rd, Dakha, Punjab 141102",
    link: "#",
    icon: "/images/contact-us/showroom-icon-6.webp",
  },
];
      ...
      <div className="max-1920">
        <div className="container">
          ...
          <div className="flex flex-wrap justify-between mt-[5rem]">
            <div className="w-full mb-[5rem] lg:w-[23%] lg:mb-0">
              <div className="bg-white px-[3rem] py-[2rem] rounded-[1rem] max-w-[390px] mx-auto  sm:max-w-none lg:rounded-[2rem] lg:py-[1rem]">
              <ul className="grid grid-cols-2 sm:grid-cols-4 sm:gap-x-[1rem] lg:block">
                {usps.map((usp, index) => (
                  <li key={index} className="my-[1.5rem] lg:my-[2rem]">
                    <h6 className="font-medium text-[#212121] text-[2rem] 3xl:text-[3.4rem]">
                      {usp.title}
                    </h6>
                    <p className="font-extralight text-[#212121] text-[1.4rem] 3xl:text-[2.4rem]">
                      {usp.subtitle}
                    </p>
                  </li>
                ))}
            ...
            <div className="w-full lg:w-[71%]">
              <ul className="border-t border-t-[#B2B2B2]">
                {showrooms.map((showroom, index) => (
                  <li className="flex flex-wrap justify-between py-[3rem] border-b border-b-[#B2B2B2]" key={index}>
                    <div className="flex flex-wrap w-full items-center sm:w-[35%] lg:w-[37%]">
                      <div className="w-[5rem] lg:w-[6.5rem] 3xl:w-[12rem]">
                        <img
                          src={showroom.icon}
                          alt={showroom.title}
                      ...
                      <h5 className="flex-[1] pl-[2rem] text-[2rem] leading-[1.2] 3xl:text-[4rem] font-medium " dangerouslySetInnerHTML={{__html:showroom.title}}></h5>
                    </div>
                    <div className="w-full mt-[2rem] font-light text-[#313131] sm:w-[60%] lg:w-[53%] lg:flex lg:justify-between lg:items-start lg:mt-[1rem]">
                        <p className="text-[1.3rem] lg:text-[1.1rem] 3xl:text-[2rem] lg:flex-[1] lg:pr-[3rem]">{showroom.address}</p>
                        <p className="mt-[1rem] text-[1.3rem] lg:text-[1.1rem] 3xl:text-[2rem] lg:w-max lg:mt-0"><a href={showroom.link} className="underline hover:text-black transition-all">Locate on map</a></p>
                    </div>
                  </li>
                ))}
              </ul>
