...
const TermsAndConditions = () => {
  return (
    <main>
      ...
      <section className="generic-main-section bg-white py-[6rem] md:py-[8rem] lg:py-[10rem] xl:py-[12rem] 1xl:py-[13rem] 3xl:py-[14rem]">
        <div className="max-1920">
          <div className="generic-content px-[20px] sm:px-[30px] md:px-[50px] xl:w-[59.5%] 1xl:w-[56.5%] 3xl:w-[60%] 3xl:max-w-[1035px] mx-auto">
            ...
            <div className={`mt-[3rem] xxl:mt-[4rem] 2xl:mt-[5rem] 3xl:mt-[7rem] ${styles.textStyles}`}>
              <h2>
                <b>Overview</b>
              </h2>
              <br />
              ...
              <h2>
                Section 1 - <b>Online Store Terms</b>
              </h2>
              <br />
              ...
              <br />
              <h2>
                Section 2 - <b>General Conditions</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 4 - <b>Modifications of The Services and Prices</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 5 - <b>Products or Services (if applicable)</b>
              </h2>
              <br />
              <p>
              ...
              <p>
                ...
                notice, at the sole discretion of us.{" "}
                <b>
              ...
              <br />
              <h2>
                Section 6 - <b>Accuracy of Billing and Account Information</b>
              </h2>
              <br />
              <p>
              ...
              <p>
                ...
                subject to these <b>Terms of Service.</b>
              </p>
              <br />
              <br />
              <h2>
                Section 8 - <b>Third Party Links</b>
              </h2>
              <br />
              <p>
              ...
              <p>
                ...
                or accuracy and we do not warrant and will not have any
              ...
              <br />
              <h2>
                Section 9 - <b>User Comments, Feedback and Other Submissions</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 10 - <b>Personal Information</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 11 - <b>Errors, Inaccuracies and Omissions</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 12 - <b>Prohibited Uses</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <p>
                In no case shall <b>Big Boy Toyz</b> Pvt Ltd, our directors,
              ...
              <br />
              <h2>
                Section 14 - <b>Indemnification</b>
              </h2>
              <br />
              <p>
                You agree to indemnify, defend and hold harmless Big Boy Toyz
              ...
              <br />
              <h2>
                Section 17 - <b>Entire Agreement</b>
              </h2>
              <br />
              <p>
                The obligations and liabilities of the parties incurred prior to
              ...
              <p>
                ...
                <b>
                  Plot No. 104, Sector 37-1, Pace City Gurgaon Haryana India
                  122001.
                </b>
              </p>
              <br />
              <br />
              <h2>
                Section 19 - <b>Changes to Terms of Service</b>
              </h2>
              <br />
              <p>
              ...
              <br />
              <h2>
                Section 20 - <b>Scope</b>
              </h2>
              <br />
              <p>
                <b>
                  Products and cars mentioned on the Big Boy Toyz website are
                  subject to stock availability.
                </b>{" "}
                All prices shown do not include extra costs, such as, but not
                limited to, taxes, change in registration, and transportation.
                All product information such as price, colour, engine
                specifications, service history, registration, etc is accurate
                to the day and date of posting.{" "}
                <b>
                  For specific product availability, finance, insurance,
                  registration and sales please visit our studio or showroom or
                  contact us on the numbers provided on our website by different
                  departments.
                </b>
              </p>
              <br />
              ...
              <h2>
                Section 21 -{" "}
                <b>Restrictions on Use of Big Boy Toyz Materials</b>
              </h2>
              <br />
              <p>
                You are not authorized to modify, copy, distribute, transmit,
                display, reproduce, publish, license, create derivative works
                from, transfer or sell any information, products, services or
                images obtained from any Big Boy Toyz websites, directly or
                indirectly in any medium. Neither these materials nor any
                portion thereof may be stored in a computer except for personal
                and non-commercial use.{" "}
                <b>
                  Big Boy Toyz will not be held liable for any delays, errors or
                  omissions there from, or in the transmission or delivery of
                  all or any part thereof, or for any damages arising from any
                  of the foregoing.
                </b>
              </p>
              <br />
              <br />
              <h2>
                Section 22 - <b>Live Chat</b>
              </h2>
              <br />
              <p>
                Big Boy Toyz implements a Live Chat feature which enables you to
                connect with our team directly and instantly. The data you fill
                out such as Name, Email ID, Phone Number and Message is stored
                in our database.
              </p>
              <br />
              <p>
                The conversation between you and our Live Chat representative is
                recorded for internal training and safety purpose. No part of
                this conversation is given to Third Party Users or impeached by
                any department. Every conversation is stored for future
                references so as to make your experience more personalised and
                relevant.
              </p>
              <br />
              <p>
                <b>
                  By using live chat, you adhere to the terms of our policy.
                </b>
              </p>
              <br />
              <br />
              <h2>
                Section 23 - <b>Live Chat</b>
              </h2>
              <br />
              <p>
                <a href="/">
...
const styles = {
  textStyles:
    "[&_h2]:text-[2.5rem] [&_h2]:leading-[1.2] [&_h2]:tracking-[-1px] xl:[&_h2]:text-[3rem] xl:[&_h2]:tracking-[-2px] xl:[&_h2]:tracking-[-1px] 1xl:[&_h2]:text-[3.3rem] 2xl:[&_h2]:text-[3.5rem] 3xl:[&_h2]:text-[4.5rem] 3xl:[&_h2]:tracking-[-2px] [&_h2]:font-light font-light text-[#080808]",
};
