  ...
  usp:[
    {
      ...
      description:"Insure your home and everything in it. BBT’s Home Secure provides all-inclusive protection for your biggest investment and protects you from all your related worries.",
      icon:"/images/insurance/ins-detail-icon-1.webp"
    },
    {
      title:"Accidental Cover",
      description:"It provides  compensation in case the owner-driver of the car suffers from bodily  injuries, permanent disability or death following the car accident.",
      icon:"/images/insurance/ins-detail-icon-2.webp"
    },
    {
      title:"Depreciation Cover ",
      description:"BBT’s Home Secure provides  all-inclusive protection for your biggest investment and protects you from all your related worries.",
      icon:"/images/insurance/ins-detail-icon-3.webp"
    },
    {
      title:"Third Party Cover",
      description:"Third-party insurance is a mandatory motor insurance policy that covers third-party related financial and legal liabilities caused due to an accident from an insured vehicle.",
      icon:"/images/insurance/ins-detail-icon-4.webp"
    },
    {
      title:"Personal Accident Cover",
      description:"Personal Accident Insurance policy provides complete financial protection to the insured members against uncertainties such as accidental death.",
